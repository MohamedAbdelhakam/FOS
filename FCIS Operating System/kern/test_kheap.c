...
int test_krealloc() {
	...
	cprintf("[AUTO_GR@DING_PARTIAL]0.1\n");
	...
	cprintf("\b\b\b20%");
	cprintf("[AUTO_GR@DING_PARTIAL]0.2\n");
	...
	cprintf("\b\b\b30%");
	cprintf("[AUTO_GR@DING_PARTIAL]0.3\n");
    {
	...
	cprintf("\b\b\b60%");
	cprintf("[AUTO_GR@DING_PARTIAL]0.6\n");
	...
	cprintf("\n[AUTO_GR@DING]Congratulations!! test krealloc completed successfully.\n");
	return 0;
}
